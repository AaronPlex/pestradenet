...
V(pestMoveNet)$ExtentCat<-factor(V(pestMoveNet)$ExtentCat,
                                 levels = c("Unreported", "Eradicated", "No longer present", "Intercepted only", "Transient under eradication", "Few occurrences", "Exporting interceptions", "Localized", "Present", "Widespread"))
...
joint.net <- ggraph(pestMoveNet, layout = "centrality", cent = joint.risk^(1/4))+
  ...
  scale_fill_manual(values = c("Unreported" = "#FCB519FF", "Eradicated" = "#FCB519FF", "No longer present" = "#FCB519FF", "Intercepted only" = "#FCB519FF", "Transient under eradication" = "#F98C0AFF", "Few occurrences" = "#E35932FF", "Exporting interceptions" = "#BB3754FF", "Localized" = "#BB3754FF", "Present" = "#89226AFF", "Widespread" =  "#56106EFF"))+
  scale_color_manual(values = c("Unreported" = "#FCB519FF", "Eradicated" = "#FCB519FF", "No longer present" = "#FCB519FF", "Intercepted only" = "#FCB519FF", "Transient under eradication" = "#F98C0AFF", "Few occurrences" = "#E35932FF", "Exporting interceptions" = "#BB3754FF", "Localized" = "#BB3754FF", "Present" = "#89226AFF", "Widespread" =  "#56106EFF"))+
  coord_fixed()+
  theme_graph()+
